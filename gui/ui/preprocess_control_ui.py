...
class Ui_PrepCtrlWidget(object):
    def setupUi(self, PrepCtrlWidget):
        ...
        self.spinbox_gama.setSingleStep(0.1)
        ...
        self.spinbox_guass_blur_size.setSingleStep(2)
        self.spinbox_guass_blur_size.setProperty("value", 3)
        ...
        self.label_canny_max.setMinimumSize(QtCore.QSize(50, 0))
        self.label_canny_max.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        ...
        self.spinbox_canny_max.setMaximumSize(QtCore.QSize(100, 16777215))
        self.spinbox_canny_max.setMaximum(10.0)
        self.spinbox_canny_max.setSingleStep(0.1)
        ...
        self.label_canny_min.setMinimumSize(QtCore.QSize(50, 0))
        self.label_canny_min.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        ...
        self.spinbox_canny_min.setMaximumSize(QtCore.QSize(100, 16777215))
        self.spinbox_canny_min.setMaximum(10.0)
        self.spinbox_canny_min.setSingleStep(0.1)
        self.spinbox_canny_min.setObjectName("spinbox_canny_min")
        self.horizontalLayout.addWidget(self.spinbox_canny_min)
        self.paramsLayout.setLayout(8, QtWidgets.QFormLayout.FieldRole, self.horizontalLayout)
        self.label_canny = QtWidgets.QLabel(PrepCtrlWidget)
        self.label_canny.setObjectName("label_canny")
        self.paramsLayout.setWidget(8, QtWidgets.QFormLayout.LabelRole, self.label_canny)
        ...
        self.label_hat_direction.setObjectName("label_hat_direction")
        self.paramsLayout.setWidget(7, QtWidgets.QFormLayout.LabelRole, self.label_hat_direction)
        self.layout_hat_options = QtWidgets.QHBoxLayout()
        self.layout_hat_options.setSizeConstraint(QtWidgets.QLayout.SetMaximumSize)
        self.layout_hat_options.setObjectName("layout_hat_options")
        self.checkbox_top_hat = QtWidgets.QCheckBox(PrepCtrlWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.checkbox_top_hat.sizePolicy().hasHeightForWidth())
        self.checkbox_top_hat.setSizePolicy(sizePolicy)
        self.checkbox_top_hat.setMinimumSize(QtCore.QSize(100, 0))
        self.checkbox_top_hat.setObjectName("checkbox_top_hat")
        self.layout_hat_options.addWidget(self.checkbox_top_hat)
        self.checkbox_back_hat = QtWidgets.QCheckBox(PrepCtrlWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.checkbox_back_hat.sizePolicy().hasHeightForWidth())
        self.checkbox_back_hat.setSizePolicy(sizePolicy)
        self.checkbox_back_hat.setMinimumSize(QtCore.QSize(100, 0))
        self.checkbox_back_hat.setObjectName("checkbox_back_hat")
        self.layout_hat_options.addWidget(self.checkbox_back_hat)
        self.paramsLayout.setLayout(7, QtWidgets.QFormLayout.FieldRole, self.layout_hat_options)
        self.label_sigmod = QtWidgets.QLabel(PrepCtrlWidget)
        self.label_sigmod.setObjectName("label_sigmod")
        self.paramsLayout.setWidget(6, QtWidgets.QFormLayout.LabelRole, self.label_sigmod)
        ...
        self.label_sigmod_center = QtWidgets.QLabel(PrepCtrlWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.label_sigmod_center.sizePolicy().hasHeightForWidth())
        self.label_sigmod_center.setSizePolicy(sizePolicy)
        self.label_sigmod_center.setMinimumSize(QtCore.QSize(50, 0))
        self.label_sigmod_center.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        self.label_sigmod_center.setObjectName("label_sigmod_center")
        self.horizontalLayout_copy.addWidget(self.label_sigmod_center)
        self.spinbox_sigmod_center = QtWidgets.QDoubleSpinBox(PrepCtrlWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.spinbox_sigmod_center.sizePolicy().hasHeightForWidth())
        self.spinbox_sigmod_center.setSizePolicy(sizePolicy)
        self.spinbox_sigmod_center.setMinimumSize(QtCore.QSize(100, 0))
        self.spinbox_sigmod_center.setMaximumSize(QtCore.QSize(100, 16777215))
        self.spinbox_sigmod_center.setMaximum(10.0)
        self.spinbox_sigmod_center.setSingleStep(0.1)
        self.spinbox_sigmod_center.setObjectName("spinbox_sigmod_center")
        self.horizontalLayout_copy.addWidget(self.spinbox_sigmod_center)
        self.label_sigmod_zoom = QtWidgets.QLabel(PrepCtrlWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.label_sigmod_zoom.sizePolicy().hasHeightForWidth())
        self.label_sigmod_zoom.setSizePolicy(sizePolicy)
        self.label_sigmod_zoom.setMinimumSize(QtCore.QSize(50, 0))
        self.label_sigmod_zoom.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        self.label_sigmod_zoom.setObjectName("label_sigmod_zoom")
        self.horizontalLayout_copy.addWidget(self.label_sigmod_zoom)
        self.spinbox_sigmod_zoom = QtWidgets.QDoubleSpinBox(PrepCtrlWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.spinbox_sigmod_zoom.sizePolicy().hasHeightForWidth())
        self.spinbox_sigmod_zoom.setSizePolicy(sizePolicy)
        self.spinbox_sigmod_zoom.setMinimumSize(QtCore.QSize(100, 0))
        self.spinbox_sigmod_zoom.setMaximumSize(QtCore.QSize(100, 16777215))
        self.spinbox_sigmod_zoom.setMaximum(10.0)
        self.spinbox_sigmod_zoom.setObjectName("spinbox_sigmod_zoom")
        self.horizontalLayout_copy.addWidget(self.spinbox_sigmod_zoom)
        self.paramsLayout.setLayout(6, QtWidgets.QFormLayout.FieldRole, self.horizontalLayout_copy)
        self.label_sobel = QtWidgets.QLabel(PrepCtrlWidget)
        self.label_sobel.setObjectName("label_sobel")
        self.paramsLayout.setWidget(5, QtWidgets.QFormLayout.LabelRole, self.label_sobel)
        self.checkbox_sobel_y = QtWidgets.QCheckBox(PrepCtrlWidget)
        self.checkbox_sobel_y.setObjectName("checkbox_sobel_y")
        self.paramsLayout.setWidget(5, QtWidgets.QFormLayout.FieldRole, self.checkbox_sobel_y)
    ...
    def retranslateUi(self, PrepCtrlWidget):
        ...
        self.label_hat_direction.setText(_translate("PrepCtrlWidget", "Hat Direction :"))
        self.checkbox_top_hat.setText(_translate("PrepCtrlWidget", "TopHat"))
        self.checkbox_back_hat.setText(_translate("PrepCtrlWidget", "BackHat"))
        self.label_sigmod.setText(_translate("PrepCtrlWidget", "Sigmod :"))
        self.label_sigmod_center.setText(_translate("PrepCtrlWidget", "Center:"))
        self.label_sigmod_zoom.setText(_translate("PrepCtrlWidget", "Zoom:"))
        self.label_sobel.setText(_translate("PrepCtrlWidget", "Sobel :"))
        self.checkbox_sobel_y.setText(_translate("PrepCtrlWidget", "Y"))
