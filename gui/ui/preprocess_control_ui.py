...
class Ui_PrepCtrlWidget(object):
    def setupUi(self, PrepCtrlWidget):
        ...
        self.paramsLayout.setLayout(6, QtWidgets.QFormLayout.FieldRole, self.horizontalLayout)
        self.label_canny = QtWidgets.QLabel(PrepCtrlWidget)
        self.label_canny.setObjectName("label_canny")
        self.paramsLayout.setWidget(6, QtWidgets.QFormLayout.LabelRole, self.label_canny)
        self.label_show_verbose = QtWidgets.QLabel(PrepCtrlWidget)
        self.label_show_verbose.setObjectName("label_show_verbose")
        self.paramsLayout.setWidget(7, QtWidgets.QFormLayout.LabelRole, self.label_show_verbose)
        ...
        self.paramsLayout.setWidget(7, QtWidgets.QFormLayout.FieldRole, self.checkbox_show_verbose)
        self.label = QtWidgets.QLabel(PrepCtrlWidget)
        self.label.setObjectName("label")
        self.paramsLayout.setWidget(5, QtWidgets.QFormLayout.LabelRole, self.label)
        ...
        self.paramsLayout.setLayout(5, QtWidgets.QFormLayout.FieldRole, self.layout_hat_options)
